...
function Mapm3() {
  ...
  return (
    <div>
      ...
      <h1 style={{ fontWeight: 400}}>Map: # of Mastodon toots mentioning HOUSE RENTING topic with sentiment class</h1>
